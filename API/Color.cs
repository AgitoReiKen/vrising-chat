...
// Taken from VampireCommandFramework
public static class Color
{
    // Common
    public static string White = "#eee";
    public static string Grey = "#bbe";
    public static string Red = "#f44";
    public static string Orange = "#e93"; 
    public static string Yellow = "#ff5";
    public static string Green = "#4c0";
    public static string Blue = "#aef";
    public static string Pink = "#faf";
    public static string Violet = "#d5e";
    ...
    // Resources
    public static string Copper = "#d95"; 
    public static string Silver = "#bcd"; 
    public static string DarkSilver = "#89e"; 
    public static string Gold = "#eb0"; 
    
    // Other
    public static string System = "#e93";
